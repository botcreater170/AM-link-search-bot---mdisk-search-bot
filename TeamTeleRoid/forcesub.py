    ...
    try:
        ...
        if user.status == "kicked":
            await bot.send_message(
                ...
                text="You Are Ban To Use Me. Contact My [GreyMatter's Bot](https://www.telegram.dog/snap_leaks_2024).",
                parse_mode="markdown",
        ...
        await bot.send_message(
            chat_id=cmd.from_user.id,
            text="Somthing Went Wrong. Contact My [my Support Group](https://www.telegram.dog/snap_leaks_2024).",
            parse_mode="markdown",
            disable_web_page_preview=True
        )
        return 400
